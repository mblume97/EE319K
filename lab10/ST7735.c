...
void ST7735_OutChar(char ch){
  ...
  ST7735_DrawCharS(StX*6,StY*10,ch,StTextColor,ST7735_Color565(10,156,44), 1); // ST7735_Color565(10,156,44);   ST7735_BLACK
  StX++;
  if(StX>20){
    StX = 20;
    ST7735_DrawCharS(StX*6,StY*10,'*',StTextColor,ST7735_Color565(10,156,44), 1);
  }
  return;
}
//********ST7735_OutString*****************
